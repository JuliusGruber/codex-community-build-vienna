...
tags:
  - "clippings"
  - "bookmark-import"
description: "To give an LLM context, I can ask the LLM to interview me for it"
---
...
I first saw a decent description of this approach in [Harper Reed's blog](https://harper.blog/2025/02/16/my-llm-codegen-workflow-atm/). A striking element of his approach is insisting that the LLM ask only one question at a time. (When I tried it, I found it needed to be frequently reminded of this.)
